...
const FlashCardItem = ({ name, avatar, number, author }) => {
  return (
    <div className="relative min-w-[290px] max-w-[290px] p-6 space-y-10 bg-white border-2 cursor-pointer border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 
