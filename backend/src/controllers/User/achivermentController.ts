...
import achivermentService from "../../services/User/achivermentService";
...
const getAchievementByUserId = async (req: Request, res: Response) => {
  try {
    ...
    const achievement = await achivermentService.getAchievementByUserId(
      user_id
    );
    sendSuccess(res, achievement);
  } catch (error) {
...
const getAchievementByAchievementId = async (req: Request, res: Response) => {
  try {
    ...
    const achievement = await achivermentService.getAchievementByAchievementId(
      achievement_id
    );
    sendSuccess(res, achievement);
  } catch (error) {
...
const getAchivementOfLevel = async (req: Request, res: Response) => {
  try {
    ...
    const achievement = await achivermentService.getAchivementOfLevel(
      Number(level)
    );
    sendSuccess(res, achievement);
  } catch (error) {
...
const unlockAchievement = async (req: Request, res: Response) => {
  try {
    ...
    const achievement = await achivermentService.unlockAchievement(
      user_id,
      Number(user_level)
    );
    sendSuccess(res, achievement);
