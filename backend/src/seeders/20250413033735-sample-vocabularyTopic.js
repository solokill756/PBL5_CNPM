    ...
    await queryInterface.bulkInsert("vocabulary_topic", [
      {
        ...
        created_at: new Date(),
        image_url: "https://japanlife-guide.com/wp-content/uploads/2020/02/jlgblog-japanese-it1.jpg",
      },
      {
        topic_id: "it-topic-02",
        name: "ソフトウェア開発",
        description: "Phát triển phần mềm",
        image_url: "https://th.bing.com/th/id/OIP.J_bMnQppSI-a2gHp6SqkTgHaGE?rs=1&pid=ImgDetMain",
        created_at: new Date(),
      },
      {
        ...
        image_url: "https://th.bing.com/th/id/OIP.I1TXvCxrlqBhzwDXlLsKOgHaE8?w=675&h=450&rs=1&pid=ImgDetMain",
        created_at: new Date(),
      },
      {
        topic_id: "it-topic-04",
        name: "データベース",
