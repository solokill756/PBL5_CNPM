...
vocabularyRouter.post('/updateVocabularyUser', vocabularyController.updateVocabularyUser);
vocabularyRouter.get('/topicDetails/:topic_id', vocabularyController.getTopicVocabularyByID);
