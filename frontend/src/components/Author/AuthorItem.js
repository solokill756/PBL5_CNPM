...
const AuthorItem = ({ name, avatar, numberClass, numberFlashcard}) => {
  return (
    <div className="relative min-w-[290px] w-[290px] p-6 space-y-4 bg-white border-2 cursor-pointer border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 
