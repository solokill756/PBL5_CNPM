...
const Mention = ({title, infor, options}) => {
        ...
        <div className='flex-col justify-between items-center'>
            <div className='flex flex-row justify-between items-center mb-4'>
                ...
                <div className='w-11 flex flex-row justify-between items-center'>
                    <div
                        onClick={toggle}
                        className={`w-10 h-5 flex items-center bg-gray-300 rounded-full cursor-pointer transition-all duration-300 ${
                            isOn ? "bg-red-200" : ""
                        }`}
                        >
                        <div
                            className={`w-6 h-6 rounded-full shadow-md transform duration-300 ease-in-out
                            ${isOn ? "translate-x-4 bg-red-800" : "bg-white"}
                            `}
                        ></div>
                    </div>
                </div>
